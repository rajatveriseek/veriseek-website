  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Expert Panel Section */}
<div className=" rounded-xl shadow-lg mt-12 max-w-3xl mx-auto transform transition-all duration-300 hover:shadow-xl"style={{ backgroundColor: navyBlue }}>
  <div className="p-6 border-l-4 flex items-center gap-4" >
    {/* Shark Image */}
    <img 
      src="/shark.png" 
      alt="Shark Icon" 
      className="w-20 h-20 text-wh object-contain"
    />
