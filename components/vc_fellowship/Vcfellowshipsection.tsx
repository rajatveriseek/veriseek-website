    ...
    <section className="vcf-section-wrap">
      <div className="vcf-inner">
        ...
        <div className="vcf-img-wrap">
          {imageSrc ? (
            <img src={imageSrc} alt="VC Fellowship programme" />
          ) : (
        ...
        <div className="vcf-card">
          <h2 className="vcf-card-heading">
            About <em>VC Fellowship</em>
          </h2>

          <p className="vcf-card-body">
            VC Fellowship is a 2 day immersion for students to understand how real investment
