...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 720px) {
    ...
    /* College badges: smaller on mobile */
    .vc-college-badge {
      height: 60px !important;
      padding: 4px 10px !important;
    }

    /* Association pill: wrap gracefully */
    .vc-association-pill {
      padding: 10px 14px 10px 14px !important;
      gap: 8px !important;
    }

    /* Eyebrow logos: slightly smaller */
    .vc-eyebrow-logos {
      gap: 6px !important;
    }
  }
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
            ...
            >
              <a href="https://nandancapital.com/" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block" }}>
                <img
                  ...
                  alt="Nandan Capital Logo"
                  style={{ height: 52, width: "auto", maxWidth: 76, objectFit: "contain", display: "block", background: "white", borderRadius: 4, cursor: "pointer" }}
                />
              </a>
      ...
      <section className="vc-info-strip" ref={infoSectionRef} style={{ textAlign: "left", alignItems: "stretch" }}>
        ...
        <div className="vc-info-grid vc-viewport-anim">
              ...
              <div className="vc-association-pill" style={{ marginBottom: 44 }}>
                ...
                <a href="https://nandancapital.com/" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block" }}>
                  <img
                    src="/images/Nandan_Final_Logo_page-0001_12-removebg-preview.png"
                    alt="Nandan Capital"
                    style={{ height: 52, width: "auto", maxWidth: 90, objectFit: "contain", display: "block", cursor: "pointer" }}
                  />
                </a>
                <a href="https://www.linkedin.com/company/himlandcapitaladvisors" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block" }}>
                  <img
                ...
                <img
                  src="/images/IMG_5883.PNG"
                  alt=""
                  style={{ height: 52, width: "auto", maxWidth: 90, objectFit: "contain", display: "block" }}
                />
              </div>
            )}
              ...
              {colleges.map((c) => (
                <span key={c} className="vc-college-badge">
                  <img
                    src={c}
                    alt=""
                    style={{ height: 52, width: "auto", maxWidth: 64, objectFit: "contain", display: "block" }}
                  />
                </span>
              ))}
            </div>
